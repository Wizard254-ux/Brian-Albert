     ...
     if request.method == 'POST': 
        ...
        if temp :
            if moisture:
               ...
               print(new_data.temp)
               socketio.emit('update_data', new_data)#if u want aonly people in message sot listen for the event you would specify /messages as the namespace
               print("ndesa")
